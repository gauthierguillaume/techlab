...
function getMarvelTokonKeyArtUrl(slug) {
  return `${MARVEL_TOKON_KEY_ART_BASE_URL}${slug}.png`;
}
...
const games = [
  ...
  },
  {
    ...
    characters: [
      { name: 'Storm', slug: 'storm', tagSlug: 'STORM', team: 'Unbreakable X-Men', railImageUrl: getMarvelTokonPortraitUrl('storm'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('storm'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Storm', officialUrl: null },
      { name: 'Magik', slug: 'magik', tagSlug: 'MAGIK', team: 'Unbreakable X-Men', railImageUrl: getMarvelTokonPortraitUrl('magik'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('magik'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 0.98, artX: '0px', artY: '16px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Magik', officialUrl: null },
      { name: 'Wolverine', slug: 'wolverine', tagSlug: 'WOLVERINE', team: 'Unbreakable X-Men', railImageUrl: getMarvelTokonPortraitUrl('wolverine'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('wolverine'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.1, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Wolverine', officialUrl: null },
      { name: 'Danger', slug: 'danger', tagSlug: 'DANGER', team: 'Unbreakable X-Men', railImageUrl: getMarvelTokonPortraitUrl('danger'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('danger'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.06, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Danger', officialUrl: null },
      { name: 'Spider-Man', slug: 'spider-man', tagSlug: 'SPIDERMAN', team: 'Amazing Guardians', railImageUrl: getMarvelTokonPortraitUrl('spider-man'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('spider-man'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Spider-Man', officialUrl: null },
      { name: 'Ms. Marvel', slug: 'ms-marvel', tagSlug: 'MSMARVEL', team: 'Amazing Guardians', railImageUrl: getMarvelTokonPortraitUrl('ms-marvel'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('ms-marvel'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Ms._Marvel', officialUrl: null },
      { name: 'Star-Lord', slug: 'star-lord', tagSlug: 'STARLORD', team: 'Amazing Guardians', railImageUrl: getMarvelTokonPortraitUrl('star-lord'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('star-lord'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.07, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Star-Lord', officialUrl: null },
      { name: 'Peni Parker', slug: 'peni-parker', tagSlug: 'PENIPARKER', team: 'Amazing Guardians', railImageUrl: getMarvelTokonPortraitUrl('peni-parker'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('peni-parker'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.05, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Peni_Parker', officialUrl: null },
      { name: 'Captain America', slug: 'captain-america', tagSlug: 'CAPTAINAMERICA', team: 'Fighting Avengers', railImageUrl: getMarvelTokonPortraitUrl('captain-america'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('captain-america'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Captain_America', officialUrl: null },
      { name: 'Iron Man', slug: 'iron-man', tagSlug: 'IRONMAN', team: 'Fighting Avengers', railImageUrl: getMarvelTokonPortraitUrl('iron-man'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('iron-man'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Iron_Man', officialUrl: null },
      { name: 'Black Panther', slug: 'black-panther', tagSlug: 'BLACKPANTHER', team: 'Fighting Avengers', railImageUrl: getMarvelTokonPortraitUrl('black-panther'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('black-panther'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Black_Panther', officialUrl: null },
      { name: 'Hulk', slug: 'hulk', tagSlug: 'HULK', team: 'Fighting Avengers', railImageUrl: getMarvelTokonPortraitUrl('hulk'), size: 'big', imageUrl: getMarvelTokonKeyArtUrl('hulk'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.12, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Hulk', officialUrl: null },
      { name: 'Doctor Doom', slug: 'doctor-doom', tagSlug: 'DOCTORDOOM', team: 'Knights of Doom', railImageUrl: getMarvelTokonPortraitUrl('doctor-doom'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('doctor-doom'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.1, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Doctor_Doom', officialUrl: null },
      { name: 'Magneto', slug: 'magneto', tagSlug: 'MAGNETO', team: 'Knights of Doom', railImageUrl: getMarvelTokonPortraitUrl('magneto'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('magneto'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Magneto', officialUrl: null },
      { name: 'Green Goblin', slug: 'green-goblin', tagSlug: 'GREENGOBLIN', team: 'Knights of Doom', railImageUrl: getMarvelTokonPortraitUrl('green-goblin'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('green-goblin'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.08, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Green_Goblin', officialUrl: null },
      { name: 'Carnage', slug: 'carnage', tagSlug: 'CARNAGE', team: 'Knights of Doom', railImageUrl: getMarvelTokonPortraitUrl('carnage'), size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('carnage'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.1, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Carnage', officialUrl: null },
      { name: 'Ghost Rider', slug: 'ghost-rider', tagSlug: 'GHOSTRIDER', team: 'Samurai Outriders', size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('ghost-rider'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.1, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Ghost_Rider', officialUrl: null },
      { name: 'Blade', slug: 'blade', tagSlug: 'BLADE', team: 'Samurai Outriders', railImageUrl: './assets/marvel-tokon/character-portraits/blade.webp', size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('blade'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.02, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Blade', officialUrl: null },
      { name: 'Deadpool', slug: 'deadpool', tagSlug: 'DEADPOOL', team: 'Samurai Outriders', railImageUrl: './assets/marvel-tokon/character-portraits/deadpool.webp', size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('deadpool'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.02, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Deadpool', officialUrl: null },
      { name: 'Loki', slug: 'loki', tagSlug: 'LOKI', team: 'Samurai Outriders', railImageUrl: './assets/marvel-tokon/character-portraits/loki.webp', size: 'medium', imageUrl: getMarvelTokonKeyArtUrl('loki'), imageFit: 'contain', imagePosition: 'center bottom', artScale: 1.04, artX: '0px', artY: '0px', wikiUrl: 'https://www.dustloop.com/w/MTFS/Loki', officialUrl: null }
    ],
  },
  {
    id: 'avatar-legends',
...
const COMBO_ASSIST_HEAD_IMAGES = {
  ...
  'black-panther': 'assets/marvel-tokon/combo-builder/assists/black-panther.png',
  blade: 'assets/marvel-tokon/combo-builder/assists/blade.png',
  'captain-america': 'assets/marvel-tokon/combo-builder/assists/captain-america.png',
  carnage: 'assets/marvel-tokon/combo-builder/assists/carnage.png',
  danger: 'assets/marvel-tokon/combo-builder/assists/danger.png',
  deadpool: 'assets/marvel-tokon/combo-builder/assists/deadpool.png',
  'doctor-doom': 'assets/marvel-tokon/combo-builder/assists/doctor-doom.png',
  'ghost-rider': 'assets/marvel-tokon/combo-builder/assists/ghost-rider.png',
  'green-goblin': 'assets/marvel-tokon/combo-builder/assists/green-goblin.png',
  hulk: 'assets/marvel-tokon/combo-builder/assists/hulk.png',
  'iron-man': 'assets/marvel-tokon/combo-builder/assists/iron-man.png',
  loki: 'assets/marvel-tokon/combo-builder/assists/loki.png',
  magik: 'assets/marvel-tokon/combo-builder/assists/magik.png',
  magneto: 'assets/marvel-tokon/combo-builder/assists/magneto.png',
  'ms-marvel': 'assets/marvel-tokon/combo-builder/assists/ms-marvel.png',
  'peni-parker': 'assets/marvel-tokon/combo-builder/assists/peni-parker.png',
  'spider-man': 'assets/marvel-tokon/combo-builder/assists/spider-man.png',
  'star-lord': 'assets/marvel-tokon/combo-builder/assists/star-lord.png',
  storm: 'assets/marvel-tokon/combo-builder/assists/storm.png',
  wolverine: 'assets/marvel-tokon/combo-builder/assists/wolverine.png',
};
